...
public class DPOPProofGenerator {
    ...
    public static void main(String args[]) throws NoSuchAlgorithmException, JOSEException, ParseException, InvalidAlgorithmParameterException, IOException, InvalidKeySpecException {
